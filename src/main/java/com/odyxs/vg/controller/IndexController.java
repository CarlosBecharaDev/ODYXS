...
public class IndexController {
    ...
    // Guía turística (página informativa pública, enlazada desde la navbar)
    @GetMapping("/guia")
    ...
    // Transporte — página informativa pública (enlazada desde la navbar)
    @GetMapping("/transporte")
    public String transporte() {
        return "transporte";
    }

    // Mapa interactivo — página pública (enlazada desde la navbar)
    @GetMapping("/mapa")
    public String mapa() {
        return "mapa";
    }
